...
const ITEMS = [
  ...
  { id: "faturas", label: "Faturas de cartão", icon: CreditCard },
  { id: "movimentacao", label: "Movimentação", icon: ListTree },
  { id: "graficos", label: "Gráficos", icon: BarChart3 },
  { id: "metas", label: "Metas", icon: Target },
  { id: "insights", label: "Insights da IA", icon: Sparkles },
];

export function DashboardSidebar({ selected = "overview" }: Props) {
  return (
    <aside className="hidden w-56 flex-shrink-0 flex-col gap-2 rounded-2xl bg-white/90 p-4 shadow-sm lg:flex">
